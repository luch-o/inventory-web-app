...
public class ProductoController {
    ...
    /*public ProductoController(ProductosRepository productosRepository) {
        ...
        Productos newProducto1 = new Productos("Tornillos",5000.0,10,1);
        Productos newProducto2 = new Productos("Laminas",6000.0,8,2);
        Productos newProducto3 = new Productos("Martillo",15000.0,20,3);
        Productos newProducto4 = new Productos("Ladrillos",3000.0,35,4);
