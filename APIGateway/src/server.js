module.exports = {
    //users_api_url: process.env.USERS_API_URL || 'https://mision-tic-users5.herokuapp.com/',
    //account_api_url: process.env.ACCOUNT_API_URL || 'https://cuentasmstest.herokuapp.com/',
    login_api_url: process.env.LOGIN_API_URL || 'https://ferreterialogin.herokuapp.com/',
    //inventory_api_url: procces.env.INVENTORY_API_URL || 'https://c4-products-ms.herokuapp.com/',
